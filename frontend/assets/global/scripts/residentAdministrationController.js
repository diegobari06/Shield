...
app.factory('residentsAccionsController', function($http) {
    return {
        ...
        deleteInvitedVisitor: function(id) {
            return $http({
                url: "http://localhost:3000/companies/3/visitants/" + id,
                method: 'DELETE'
            });
        },
        cancelInvitation: function(data) {
            return $http({
                url: "http://localhost:3000/companies/3/visitants/" + data.id,
                method: 'PUT',
                data: data
            });
        ...
        getInvitedVisitors: function(id) {
            return $http.get('http://localhost:3000/companies/3/houses/' + id + '/find/invited/visitants');
        },
        getInvitedVisitor: function(data) {
            return $http.get('http://localhost:3000/companies/3/houses/' + data.id_house + '/find/invited/visitant/' + data.id);
        },
