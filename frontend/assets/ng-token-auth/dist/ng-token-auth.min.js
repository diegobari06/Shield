"undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "ng-token-auth"), angular.module("ng-token-auth", ["ipCookie"]).provider("$auth", function() {
    ...
    return t = {
        "default": {
            ...
            createPopup: function(t) {
                return window.open(t, "_blank", "closebuttoncaption=Cancel")
            },
        ...
        configure: function(n) {
            var r, i, s, a, o, u, c, h, d;
            if (n instanceof Array && n.length) {
                for (a = h = 0, d = n.length; d > h; a = ++h) {
                    r = n[a], u = null;
        ...
        $get: ["$http", "$q", "$location", "ipCookie", "$window", "$timeout", "$rootScope", "$interpolate", "$interval", function(n) {
            return function(r, i, s, a, o, u, c, h, d) {
                return {
                    header: null,
                    dfd: null,
                    user: {},
                    ...
                    submitLogin: function(t, e, n) {
                        return null == e && (e = {}), null == n && (n = {}), this.initDfd(), r.post(this.apiUrl(e.config) + this.getConfig(e.config).emailSignInPath, t, n).success(function(t) {
                            return function(n) {
                                var r;
                    ...
                    openAuthWindow: function(t, e) {
                        var n, r;
                        if (r = this.getConfig(e.config).omniauthWindowType, n = this.buildAuthUrl(r, t, e), "newWindow" === r) return this.requestCredentialsViaPostMessage(this.getConfig().createPopup(n));
                        if ("inAppBrowser" === r) return this.requestCredentialsViaExecuteScript(this.getConfig().createPopup(n));
                    ...
                    parseLocation: function(t) {
                        var e, n, r, i, s;
                        if (n = t.substring(1), r = {}, n) {
                            s = n.split("&"), i = void 0, e = void 0;
                            for (e in s) e = e, "" !== s[e] && "function" != typeof s[e] && (i = s[e].split("="), r[decodeURIComponent(i[0])] = decodeURIComponent(i[1]))
                        }
                        return r
                    },
                    validateUser: function(t) {
                        var e, n, r, i, a, o, u, h, d;
                        return null == t && (t = {}), n = t.config, null == this.dfd && (this.initDfd(), this.userIsAuthenticated() ? this.resolveDfd() : (o = s.search(), i = this.parseLocation(window.location.search), a = 0 === Object.keys(o).length ? i : o, u = a.auth_token || a.token, void 0 !== u ? (e = a.client_id, h = a.uid, r = a.expiry, n = a.config, this.setConfigName(n), this.mustResetPassword = a.reset_password, this.firstTimeLogin = a.account_confirmation_success, this.oauthRegistration = a.oauth_registration, this.setAuthHeaders(this.buildAuthHeaders({
                            token: u,
                            clientId: e,
                            uid: h,
                            expiry: r
                        })), d = s.path() || "/", ["auth_token", "token", "client_id", "uid", "expiry", "config", "reset_password", "account_confirmation_success", "oauth_registration"].forEach(function(t) {
                            return delete a[t]
                        }), Object.keys(a).length > 0 && (d += "?" + this.buildQueryString(a)), s.url(d)) : this.retrieveData("currentConfigName") && (n = this.retrieveData("currentConfigName")), this.getConfig().forceValidateToken ? this.validateToken({
                            config: n
                        }) : isEmpty(this.retrieveData("auth_headers")) ? (this.rejectDfd({
                            reason: "unauthorized",
                            errors: ["No credentials"]
                        }), c.$broadcast("auth:invalid")) : this.tokenHasExpired() ? (c.$broadcast("auth:session-expired"), this.rejectDfd({
                            reason: "unauthorized",
                        ...
                        return null == t && (t = {}), this.tokenHasExpired() ? this.rejectDfd({
                            ...
                            return function(e) {
                                return t.firstTimeLogin && c.$broadcast("auth:email-confirmation-error", e), t.mustResetPassword && c.$broadcast("auth:password-reset-confirm-error", e), c.$broadcast("auth:validation-error", e), t.rejectDfd({
                                    reason: "unauthorized",
                                    errors: null != e ? e.errors : ["Unspecified error"]
                                })
                            }
                        }(this))
                    },
                    ...
                    invalidateTokens: function() {
                        ...
                        return this.deleteData("currentConfigName"), null != this.timer && d.cancel(this.timer), this.deleteData("auth_headers")
                    },
                    signOut: function() {
                    ...
                    persistData: function(t, e, n) {
                        ...
                        switch (this.getConfig(n).storage) {
                            ...
                            case "sessionStorage":
                                return o.sessionStorage.setItem(t, JSON.stringify(e));
                            default:
                                return a(t, e, this.getConfig().cookieOps)
                        }
                    },
                    retrieveData: function(t) {
                        ...
                        try {
                            ...
                            switch (this.getConfig().storage) {
                                ...
                                case "sessionStorage":
                                    return JSON.parse(o.sessionStorage.getItem(t));
                                default:
                                    return a(t)
                            }
                        } catch (n) {
                            if (e = n, e instanceof SyntaxError) return void 0;
                            throw e
                        }
                    },
                    deleteData: function(t) {
                        switch (this.getConfig().storage instanceof Object && this.getConfig().storage.deleteData(t), this.getConfig().storage) {
                            ...
                            case "sessionStorage":
                                return o.sessionStorage.removeItem(t);
                            default:
                                return a.remove(t, {
                    ...
                    setAuthHeaders: function(t) {
                        var e, n, r, i;
                        return n = angular.extend(this.retrieveData("auth_headers") || {}, t), i = this.persistData("auth_headers", n), e = this.getExpiry(), r = (new Date).getTime(), e > r && (null != this.timer && d.cancel(this.timer), this.timer = d(function(t) {
                            return function() {
                                return t.validateUser({
                                    config: t.getSavedConfig()
                                })
                            }
                        }(this), parseInt(e - r), 1)), i
                    },
                    initDfd: function() {
                    ...
                    getSavedConfig: function() {
                        var t, n;
                        return t = void 0, n = "currentConfigName", this.hasLocalStorage() ? null == t && (t = JSON.parse(o.localStorage.getItem(n))) : this.hasSessionStorage() && null == t && (t = JSON.parse(o.sessionStorage.getItem(n))), null == t && (t = a(n)), t || e
                    },
                    hasSessionStorage: function() {
                        var t;
                        if (null == this._hasSessionStorage) {
                            this._hasSessionStorage = !1;
                            try {
                                o.sessionStorage.setItem("ng-token-auth-test", "ng-token-auth-test"), o.sessionStorage.removeItem("ng-token-auth-test"), this._hasSessionStorage = !0
                            } catch (e) {
                                t = e
                            }
                        }
                    ...
                    hasLocalStorage: function() {
                        var t;
                        if (null == this._hasLocalStorage) {
                            this._hasLocalStorage = !1;
                            try {
                                o.localStorage.setItem("ng-token-auth-test", "ng-token-auth-test"), o.localStorage.removeItem("ng-token-auth-test"), this._hasLocalStorage = !0
                            } catch (e) {
                                t = e
                            }
                        }
    ...
    return n = function(t, e) {
        ...
        for (r in a) s = a[r], e.headers(r) && (i[r] = e.headers(r));
    ...
    for (e in t)
        if (n = t[e], Object.prototype.hasOwnProperty.call(t, e)) return !1;
    return !0
};
